...
%%
%% This module was generated on 2025-06-22T06:36:40+00:00 and should not be modified manually
%% @end

-module(etcdgun_v3electionpb_election_client).

-ignore_xref(etcdgun_v3electionpb_election_client).
